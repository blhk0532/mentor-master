...
new class extends Component
{
    ...
    {
        $this->powerupsJSON = json_decode(file_get_contents(public_path('/mentor/wix.json')));
        ...
        <div class="w-full max-w-6xl px-8 mx-auto">
            ...
            <div class="relative w-full p-6 pl-12 text-yellow-700 border border-yellow-200 rounded-lg dark:border-transparent dark:bg-yellow-500 dark:text-white bg-yellow-50">
                ...
                <div class="text-sm opacity-80 dark:opacity-100">Before deploying to production you will want to remove
                    the `pages/mentor` folder. These power-ups should only be installed with a new local app.</div>
            </div>
